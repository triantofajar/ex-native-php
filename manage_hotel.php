...
if(!isset($_GET['submit'])){
  ...
  $query = "SELECT * FROM hotel WHERE ". $_GET['search_select'] ." LIKE '%". $_GET['search_value'] ."%' ORDER BY tanggal_daftar DESC $query_limit";
  $sql = mysqli_query($connect,$query);
}
...
<table class='table table-striped' id="tblData">
  <br><br><br><br><br>
  <center><legend><h2>Manajemen Hotel</h2></legend></center>
  <br>
  <div class="row space-form ">
  <div class="col-sm-8 col-sm-offset-0">
        <a href="admin.php?menu=form_hotel" class="btn btn-sm btn-info" >
...
?>
  ...
  <tr>
      ...
      <td width="50"><a id="recruit_detail" href="admin.php?menu=edit_hotel&no=<?php echo $data['no'];?>"><span class="glyphicon glyphicon-edit"></span></a>
...
if(!isset($_GET['submit'])){
  ...
  $query = "SELECT * FROM hotel WHERE ". $_GET['search_select'] ." LIKE '%". $_GET['search_value'] ."%'";
}
