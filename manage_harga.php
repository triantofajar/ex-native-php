...
if(!isset($_GET['submit'])){
	...
	$query = "SELECT * FROM paket WHERE ". $_GET['search_select'] ." LIKE '%". $_GET['search_value'] ."%' ORDER BY tanggal_daftar DESC $query_limit";
	$sql = mysqli_query($connect,$query);
}
...
<table class='table table-striped' id="tblData">
	<br><br><br><br><br>
	<center><legend><h2>Manajemen Harga</h2></legend></center>
	<br>
	<div class="row space-form ">
  <div class="col-sm-8 col-sm-offset-0">
        <a href="admin.php?menu=tambah_harga" class="btn btn-sm btn-info" >
...
?>
	...
	<tr>
			...
			<td width="50"><a id="recruit_detail" href="admin.php?menu=edit_harga&no=<?php echo $data['no'];?>"><span class="glyphicon glyphicon-edit"></span></a></td>
			<td width="50"><a id="actdelete" href="proses_harga.php?del=1&no=<?php echo $data['no'];?>"><span class="glyphicon glyphicon-trash"></span></a></td>
...
for ($i=1; $i<=$total_pages; $i++) {
	...
	if(!isset($_GET['submit'])){
		echo "<li $active><a href='admin.php?menu=manage_harga&page=".$i."'>".$i."</a></li>";
	}else{
		echo "<li $active><a href='admin.php?menu=manage_harga&search_select=". $_GET['search_select'] ."&search_value=". $_GET['search_value'] ."&submit=". $_GET['submit'] ."&page=".$i."'>".$i."</a></li>";
	}
};
