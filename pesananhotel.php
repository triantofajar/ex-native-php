...
$hotel=$_GET['hotel'];
	...
	$query = "SELECT * FROM hotel WHERE nama_hotel='$hotel'";
...
<div class="box">
	...
	<form action="proses_pesanan.php" method="POST" enctype="multipart/form">
		...
		<input type="hidden" name="id_paket" value="<?php echo $data['no']; ?>">
			...
			<tr>
				<td width="200px">TANGGAL CHECK IN</td>
				<td width="10px">:</td>
			...
			<tr>
				...
				<td width="10px">:</td>
				<td><input type="text" name="harga" class="form-control input-md" value="<?php echo $data['tarif']; ?>"></td>
			</tr>
			<tr>
				<td width="200px">NAMA HOTEL</td>
				<td width="10px">:</td>
				<td><input type="text" name="kategori" class="form-control input-md" value="<?php echo $data['nama_hotel']; ?>"></td>
			</tr>
